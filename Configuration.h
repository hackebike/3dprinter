...
#define STRING_CONFIG_H_AUTHOR "hackebike" // Who made the changes.
 ...
 *
 */
//#define Z_MIN_PROBE_PIN 32 // Pin 32 is the RAMPS defaultSDSUPPORT
...
#define HOMING_FEEDRATE_Z  (6*60) //Test: increase speed to test, sensitivity might need to be adjusted
